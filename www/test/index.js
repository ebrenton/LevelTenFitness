...
homeRotationImages[0].src = '/photos/homeRotation/060_400h.jpg'
...
function loadRates() {
    ...
    tmpHtml += '<tr><td style="text-align:right">1 one-hour session:</td><td style="text-align:left">$45</td></tr>'
    tmpHtml += '<tr><td style="text-align:right">5 one-hour sessions:</td><td style="text-align:left">$200</td></tr>'
    tmpHtml += '<tr><td style="text-align:right">10 one-hour sessions:</td><td style="text-align:left">$350</td></tr>'
    tmpHtml += '<tr><td colspan="2" style="text-align:middle"><br /><b><u>If I come to you...</u></b></td></tr>'
    tmpHtml += '<tr><td style="text-align:right">1 one-hour session:</td><td style="text-align:left">$55</td></tr>'
    tmpHtml += '<tr><td style="text-align:right">10 or more sessions:</td><td style="text-align:left">$50/hour</td></tr>'
